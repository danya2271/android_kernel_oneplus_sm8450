...
#define DATARMNET65d0d735fa                                                    \
	((0xdf7 + 6169 - 0x241c) * (0xdf7 + 2629 - 0x143c) *                   \
	 (0xdf7 + 2629 - 0x143c) / (0xd35 + 210 - 0xdff) *                     \
	 DATARMNET7b5bbaa047)
#define DATARMNETb8ab933cae                                                    \
	((0xc07 + 4861 - 0x1e3c) * (0xdf7 + 2629 - 0x143c) *                   \
	 (0xdf7 + 2629 - 0x143c) / (0xd35 + 210 - 0xdff) *                     \
	 DATARMNET7b5bbaa047)
static const char *DATARMNETe5ef0e617c = "\x31\x2e\x30";
static u16 DATARMNET2fe4661b82 = DATARMNET810b8d04cd;
...
static DEFINE_HASHTABLE(DATARMNET2ee773c365, (0xd0a + 237 - 0xdf2));
...
static int DATARMNET998f6cbce7(struct notifier_block *DATARMNET272c159b3c,
			       unsigned long DATARMNET9a4761f31c,
			       void *DATARMNETaef95eabe8);
static struct notifier_block DATARMNETc580548769 __read_mostly = {
	.notifier_call = DATARMNET998f6cbce7,
	.priority = (0xd1f + 216 - 0xdf5),
};
static struct DATARMNET6fd48c33f6 *DATARMNET3ed11fdc8d(u32 DATARMNETbb588401ec)
{
	struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf;
	hash_for_each_possible (DATARMNET2ee773c365, DATARMNETaa568481cf,
				hash_list, DATARMNETbb588401ec) {
		if (DATARMNETaa568481cf->DATARMNET54338da2ff
			    .DATARMNETbb588401ec == DATARMNETbb588401ec)
...
static void DATARMNET1e616c2160(struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf)
{
	...
	list_add(&DATARMNETaa568481cf->DATARMNETed4d7b4a3c,
		 &DATARMNET7520901fb5);
	DATARMNETfef55eaf9a++;
	if (DATARMNETaa568481cf->expires) {
		if (!timer_pending(&DATARMNETd21629e047) ||
		    time_before(DATARMNETaa568481cf->expires,
				DATARMNETd21629e047.expires))
			mod_timer(&DATARMNETd21629e047,
				  DATARMNETaa568481cf->expires);
	}
	if (DATARMNETfef55eaf9a == (0xd26 + 209 - 0xdf6))
		WRITE_ONCE(rmnet_aps_set_prio, DATARMNET30dd480cad);
}
static void DATARMNET7fa3dd63cb(struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf)
{
	hash_del(&DATARMNETaa568481cf->hash_list);
	list_del(&DATARMNETaa568481cf->DATARMNETed4d7b4a3c);
	if (likely(DATARMNETfef55eaf9a))
		DATARMNETfef55eaf9a--;
	else
		DATARMNET112d724eff("aps: flow count is aleady 0\n");
	if (!DATARMNETfef55eaf9a) {
		WRITE_ONCE(rmnet_aps_set_prio, NULL);
		del_timer(&DATARMNETd21629e047);
	}
	kfree(DATARMNETaa568481cf);
}
static void DATARMNET9ac8a34003(void)
{
	struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf, *DATARMNETaf503e06a5;
	...
	hash_for_each_safe (DATARMNET2ee773c365, DATARMNET5c2fd31d7b,
			    DATARMNET0386f6f82a, DATARMNETaa568481cf,
			    hash_list) {
		hash_del(&DATARMNETaa568481cf->hash_list);
		kfree(DATARMNETaa568481cf);
	}
	DATARMNETfef55eaf9a = (0xd2d + 202 - 0xdf7);
	WRITE_ONCE(rmnet_aps_set_prio, NULL);
	DATARMNET112d724eff(
...
static void DATARMNET250448eb06(int ifindex)
{
	...
	hash_for_each_safe (DATARMNET2ee773c365, DATARMNET5c2fd31d7b,
			    DATARMNET0386f6f82a, DATARMNETaa568481cf,
			    hash_list) {
		if (DATARMNETaa568481cf->DATARMNET54338da2ff.ifindex ==
		    ifindex) {
			DATARMNET112d724eff(
...
static void DATARMNETf844db79d9(struct timer_list *DATARMNET6e4292679f)
{
	...
	hash_for_each_safe (DATARMNET2ee773c365, DATARMNET5c2fd31d7b,
		...
		if (!DATARMNETaa568481cf->expires)
			continue;
		if (time_before_eq(DATARMNETaa568481cf->expires,
				   DATARMNET02dfdbc38d)) {
			DATARMNETbb588401ec =
				DATARMNETaa568481cf->DATARMNET54338da2ff
					.DATARMNETbb588401ec;
			DATARMNET112d724eff(
				...
				DATARMNETbb588401ec);
			DATARMNET7fa3dd63cb(DATARMNETaa568481cf);
			DATARMNET446f780f19(DATARMNETbb588401ec,
					    DATARMNETee209ff1f9);
...
static void DATARMNET3281082da4(struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf)
{
	DATARMNETaa568481cf->DATARMNET556cdfb5eb = RMNET_APS_MAJOR
						   << (0xeb7 + 1158 - 0x132d);
	if (DATARMNETaa568481cf->DATARMNET54338da2ff.DATARMNET6c2cba039d >=
	    DATARMNET3bc5e7094a)
		DATARMNETaa568481cf->DATARMNET556cdfb5eb |=
			DATARMNET9628311a6b[(0xd2d + 202 - 0xdf7)];
	else
		DATARMNETaa568481cf->DATARMNET556cdfb5eb |=
			DATARMNET9628311a6b[DATARMNETaa568481cf
						    ->DATARMNET54338da2ff
						    .DATARMNET6c2cba039d];
...
static int DATARMNET772c0b87c5(void *DATARMNETe823dcf978,
			       struct list_head *DATARMNET9cf7d31274,
			       struct list_head *DATARMNET5444bd3b6f)
{
	...
	DATARMNET40e125212a =
		list_entry(DATARMNET9cf7d31274, struct DATARMNET6fd48c33f6,
			   DATARMNETed4d7b4a3c);
	DATARMNETdcaff77beb =
		list_entry(DATARMNET5444bd3b6f, struct DATARMNET6fd48c33f6,
			   DATARMNETed4d7b4a3c);
...
static void DATARMNET5979020f87(struct work_struct *DATARMNET33110a3ff5)
{
	...
	if (DATARMNETd3eb49eab3)
		queue_delayed_work(system_power_efficient_wq,
				   &DATARMNET3481998252, DATARMNETfd026b105a);
}
static int DATARMNET82d65f9ca6(struct DATARMNET5d4139d9d7 *DATARMNETddcafd8b91)
{
	struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf;
	DATARMNETaa568481cf =
		DATARMNET3ed11fdc8d(DATARMNETddcafd8b91->DATARMNETbb588401ec);
	...
	if (DATARMNETddcafd8b91->cmd == DATARMNETceae994093 &&
	    DATARMNETaa568481cf) {
		DATARMNET112d724eff(
	...
	if (!DATARMNETaa568481cf) {
		...
		DATARMNETaa568481cf =
			kzalloc(sizeof(*DATARMNETaa568481cf), GFP_ATOMIC);
		if (!DATARMNETaa568481cf) {
			DATARMNET112d724eff(
		...
		memcpy(&DATARMNETaa568481cf->DATARMNET54338da2ff,
		       DATARMNETddcafd8b91,
		...
		DATARMNET1e616c2160(DATARMNETaa568481cf);
		DATARMNET112d724eff(
...
static int DATARMNET1d51fe00f2(struct genl_info *DATARMNET54338da2ff,
			       ...
			       gfp_t flags)
{
	...
	if (!DATARMNET54338da2ff || !DATARMNETa13fcf9070)
		return -EINVAL;
	DATARMNET543491eb0f = genlmsg_new(sizeof(*DATARMNETa13fcf9070), flags);
	if (!DATARMNET543491eb0f)
		goto DATARMNETbf4095f79e;
	DATARMNETd7f97e2e5a = genlmsg_put(
		DATARMNET543491eb0f, (0xd2d + 202 - 0xdf7),
		DATARMNET54338da2ff->snd_seq + (0xd26 + 209 - 0xdf6),
		&DATARMNETcdba30eca9, (0xd2d + 202 - 0xdf7),
		DATARMNET15437be67e);
	if (!DATARMNETd7f97e2e5a)
		goto DATARMNETbf4095f79e;
	DATARMNETb14e52a504 =
		nla_put(DATARMNET543491eb0f, DATARMNET818a0b6438,
			sizeof(*DATARMNETa13fcf9070), DATARMNETa13fcf9070);
	if (DATARMNETb14e52a504 != (0xd2d + 202 - 0xdf7))
		goto DATARMNETbf4095f79e;
	genlmsg_end(DATARMNET543491eb0f, DATARMNETd7f97e2e5a);
	DATARMNETb14e52a504 =
		genlmsg_unicast(genl_info_net(DATARMNET54338da2ff),
				DATARMNET543491eb0f,
...
static void DATARMNET446f780f19(u32 DATARMNETbb588401ec, u8 DATARMNETf8bbe3b0fb)
{
	...
	if (DATARMNET1d51fe00f2(&DATARMNET7d98961cbe, &DATARMNETa13fcf9070,
				GFP_ATOMIC)) {
		DATARMNET112d724eff(
...
{
	struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf;
	if (DATARMNET543491eb0f->priority >> (0xeb7 + 1158 - 0x132d) !=
	    DATARMNET2fe4661b82)
		return;
	...
	spin_lock_bh(&DATARMNET33bd4139f4);
	DATARMNETaa568481cf =
		DATARMNET3ed11fdc8d(DATARMNET543491eb0f->priority);
	if (DATARMNETaa568481cf) {
			       ...
			       void *DATARMNETaef95eabe8)
{
	...
	DATARMNET413e8dcf7b = netdev_notifier_info_to_dev(DATARMNETaef95eabe8);
	if (unlikely(!DATARMNET413e8dcf7b))
		return NOTIFY_DONE;
			...
			struct genl_info *DATARMNET54338da2ff)
{
	...
	case DATARMNET63ff5c35c2:
		...
		DATARMNET9ac8a34003();
		DATARMNET2fe4661b82 =
			(u16)DATARMNETddcafd8b91.DATARMNETbb588401ec;
		DATARMNET112d724eff(
	...
	case DATARMNET1efd633004:
		DATARMNETb14e52a504 = DATARMNET82d65f9ca6(&DATARMNETddcafd8b91);
		break;
	default:
	...
	DATARMNETa13fcf9070.DATARMNETbb588401ec =
		DATARMNETddcafd8b91.DATARMNETbb588401ec;
	DATARMNETb14e52a504 = DATARMNET1d51fe00f2(
		DATARMNET54338da2ff, &DATARMNETa13fcf9070, GFP_KERNEL);
	return DATARMNETb14e52a504;
}
static int __init DATARMNET0718a3fa4c(void)
{
	int DATARMNETb14e52a504;
	pr_info("\x61\x70\x73\x3a\x20\x69\x6e\x69\x74\x20\x28\x25\x73\x29"
		"\n",
		DATARMNETe5ef0e617c);
	DATARMNETb14e52a504 = DATARMNETcfa8d492f8();
	if (DATARMNETb14e52a504) {
		pr_err("\x61\x70\x73\x3a\x20\x66\x61\x69\x6c\x65\x64\x20\x74\x6f\x20\x72\x65\x67\x69\x73\x74\x65\x72\x20\x67\x65\x6e\x6c\x20\x66\x61\x6d\x69\x6c\x79"
		       "\n");
		return DATARMNETb14e52a504;
	}
