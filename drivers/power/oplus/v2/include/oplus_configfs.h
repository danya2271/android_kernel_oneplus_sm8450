...
void oplus_usb_node_delete_2(struct device_attribute **usb_attributes);
int oplus_battery_node_add_2(struct device_attribute **battery_attributes);
void oplus_battery_node_delete_2(struct device_attribute **battery_attributes);
int oplus_wireless_node_add_2(struct device_attribute **wireless_attributes);
void oplus_wireless_node_delete_2(struct device_attribute **wireless_attributes);
int oplus_common_node_add_2(struct device_attribute **common_attributes);
void oplus_common_node_delete_2(struct device_attribute **common_attributes);
