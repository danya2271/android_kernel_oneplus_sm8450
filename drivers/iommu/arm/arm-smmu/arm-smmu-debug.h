...
#define TCU_TESTBUS_SEL_MASK			GENMASK(11, 8)
#define TCU_CACHE_TESTBUS			BIT(8)
#define TCU_PTW_TESTBUS				~TCU_CACHE_TESTBUS
#define TCU_PTW_INTERNAL_STATES			3
#define TCU_PTW_INTERNAL_STATES_MASK		GENMASK(7, 2)
#define TCU_PTW_TESTBUS_SEL2			0
...
#define TCU_CACHE_LOOKUP_QUEUE_SIZE		37
#define TCU_PTW_LOOKUP_QUEUE_SIZE		32
#define TCU_CLK1_TESTBUS_SEL			0x100
#define TCU_CLK2_TESTBUS_SEL			0xb00

#define TBU_CLK_GATE_CONTROLLER_TESTBUS_SEL	BIT(0)
...
#define TBU_CMD_QUEUE_SEL			BIT(7)
...
#define	TBU_CMD_QUEUE				(0x1c0)
#define TBU_CMD_QUEUE_START			(16)
#define TBU_CMD_QUEUE_SIZE			(16)
#define TBU_CMD_QUEUE_MASK			~GENMASK(5, 0)
