 ...
 *
 *********************************************************/
static inline int i2c_r_bytes(struct aw_haptic *aw_haptic, uint8_t reg_addr, uint8_t *buf,
				uint32_t len)
{
	int ret;
	struct i2c_msg msg[] = {
...
static inline int i2c_w_bytes(struct aw_haptic *aw_haptic, uint8_t reg_addr, uint8_t *buf,
				uint32_t len)
{
	uint8_t *data = NULL;
	int ret = -1;
...
static inline int i2c_w_bits(struct aw_haptic *aw_haptic, uint8_t reg_addr, uint32_t mask,
			   uint8_t reg_data)
{
	uint8_t reg_val = 0;
	int ret = -1;
