...
static const char * const critical_performance_irqs[] = {
	"msm_drm", "touch-00", "dsi_ctrl", "disp_rsc", "kgsl_3d0_irq", "cci0", "cci1", "cvp", "ipcc_0"
};

static const char * const performance_irqs[] = {
	"ufshcd", "gsi", "i2c_geni", "msm_serial_geni0",
	"glink-native-cdsp", "glink-native-adsp", "glink-native-slpi", "rt-cdm0", "rt-cdm1", "rt-cdm2"
};
